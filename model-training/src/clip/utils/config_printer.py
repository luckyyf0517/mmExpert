...
def print_core_config(args, log_dir, cfg):
    ...
    log_message("DATA_CONFIG", f"[NORMALIZE]            : {cfg.data_cfg.params.cfg.opt.get('normalize', 'N/A')}", color="green")
    log_message("DATA_CONFIG", f"[RANDOM SCALE]         : {cfg.data_cfg.params.cfg.opt.get('random_scale', False)}", color="green")
    log_message("DATA_CONFIG", f"[THRESHOLDING]         : {cfg.data_cfg.params.cfg.opt.get('thresholding', False)}", color="green")
    log_message("DATA_CONFIG", f"[RAW]                  : {cfg.data_cfg.params.cfg.opt.get('raw', False)}", color="green")
