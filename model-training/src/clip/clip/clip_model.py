...
from ..core.base import ModalityData, ModalityType, EncodingResult
from ..core.config import ModelConfig
from ..core.registry import register_model
from ..core.factory import create_encoder
...
class CLIPModel(pl.LightningModule):
    ...
    def _create_encoders(self, encoder_configs: Dict[str, Any]) -> None:
        ...
        if "radar" in encoder_configs:
            ...
            # Temporal encoders use their native constructor; registered encoder
            # types are created through the component factory.
    ...
    def training_step(self, batch, batch_idx):
        ...
        # [INFO] Use unified forward method to compute loss
