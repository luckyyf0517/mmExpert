"""Utility helpers for standardized console logging.

This module keeps all terminal output aligned with the @tag.mdc rules:
- Only the tag portion is colored via termcolor.
- Message text stays uncolored.
- No emoji usage anywhere in the log output.
"""
