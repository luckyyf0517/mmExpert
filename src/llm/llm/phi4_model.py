...
from transformers import Phi4Model as _Phi4Model, Phi4ForCausalLM as _Phi4ForCausalLM
...
class Phi4Model(WaveBaseModel, _Phi4Model):
    """Custom Phi4Model that handles wave feature fusion"""
    ...
    def forward(
        ...
        **kwargs
        ...
        return super(Phi4Model, self).forward(
            input_ids=None,
            attention_mask=attention_mask,
...
class Phi4ForCausalLM(WaveBaseModel, _Phi4ForCausalLM):
    """Custom Phi4ForCausalLM that uses custom Phi4Model"""

    def __init__(self, config):
        super().__init__(config)
        # Replace self.model with our custom Phi4Model
    ...
    def forward(
        ...
        **kwargs
        ...
        # Call self.model (custom Phi4Model) which handles wave fusion
        outputs = self.model(
            input_ids=input_ids,
            input_wave_embeds=input_wave_embeds,
            attention_mask=attention_mask,
